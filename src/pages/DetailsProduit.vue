...
></carousel> -->
        ...
        <div class="col-md-6">
          <b-card no-body>
            ...
            <p style="margin-left: 20px; font-weight: bold">Référence:</p>
    ...
    font-size: 22px;"> {{ (produit.prix).toFixed(3) }} TND 
            ...
            <p style="margin-left: 20px; margin-top: 20px">
              Quantité: {{ produit.qts }}
            </p>
            <div
              id="product-description-short-22"
            ...
            <div class="row" style="margin-left: 20px; margin-bottom: 30px">
              <img
                loading="lazy"
                src="https://img.icons8.com/ios/25/000000/like--v1.png"
              />&nbsp; Ajouter aux favoris
            </div>
          </b-card>
        </div>
