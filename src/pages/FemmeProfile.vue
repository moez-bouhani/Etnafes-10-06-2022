...
export default {
  ...
  methods: {
    ...
    setPlace(place) {
      this.client.adresse = place;
      if (this.client.adresse) {
        const marker = {
          lat: this.client.adresse.geometry.location.lat(),
          lng: this.client.adresse.geometry.location.lng(),
        };
        this.markers.push({ position: marker });
        this.places.push(this.client.adresse);
        this.center = marker;
    ...
    updateClient(e) {
      ...
      if (this.places.length == 0) {
        ...
        formData.append("adresse", this.client.adresse.formatted_address);
