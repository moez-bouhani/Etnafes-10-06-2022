  ...
  <div>
    ...
    <div class="container">
      <center style="margin-bottom: 40px; margin-top: 20px">
        <h1 style="color: #333; margin-top: 10px">Etnafes Libre</h1>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-8 col-sm-12">
                <div class="card-body">
                  ...
                  <hr />
                  <p class="card-text" >
                    <span style="text-align: justify;">{{ hebergement.description }}</span>
                    <br />
                    <hr />
                    <small
                      class="text-muted"
                    ...
                    <br />
                    <span>
                      <img loading="lazy" src="/Etnafes-icon3.png.webp" style="width: 12px" />
          ...
          <div class="row style_row_heb_libre">
            ...
            >
              ...
              >
                ...
                <slide
                  onmouseover="this.style.cursor='pointer'"
                  class="MyCustomClass d-none d-lg-block"
                  id="carousel3"
          ...
          <div class="row">
            ...
            >
              <center>
                <img loading="lazy"
                  alt="guide"
                  :src="`${apiDomain}/myapp/public/uploads/files_guide/${guide.client.photo}`"
