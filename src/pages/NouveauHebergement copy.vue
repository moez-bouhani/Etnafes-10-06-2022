<template>
  <div class="content">
    <b-tabs card>
      <b-tab title="Ajouter un hébergement" active>
              ...
              <form @submit.prevent="createHebergement">
                ...
                <div class="row m-0 w-100">
                  <div class="col-lg-6 col-md-12">
                    ...
                    ></base-input>
                    <p
                      v-if="validationErrors.url_video"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.url_video[0] }}</span
                      >
                    </p>
                  </div>
                  <div class="col-lg-3 col-md-6 text-left">
                    <div class="form-group">
                      <label>Type resérvation </label>
                      <select
                        style="height: calc(2.25rem + 2px)"
                        class="form-control"
                        required
                        v-model="hebergement.type"
                      >
                        <option value disabled selected>
                          type de reservation
                        </option>
                        <option>Logement entier</option>
                        <option>par chambre</option>
                  ...
                  <div class="col-lg-3 col-md-6 text-left">
                    ...
                    <!--  <base-input
                      ...
                      class="numHeb"
                      placeholder="Nombre des chambres disponibles"
                      v-model="hebergement.nbr_chambre_dispo"
                    ></base-input> -->
                    <p
                      v-if="
                        validationErrors.nbr_chambre_dispo &&
                        hebergement.type == 'par chambre'
                      "
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >* {{ validationErrors.nbr_chambre_dispo[0] }}</span
                      >
                    </p>
                  </div>
                </div>
                ...
                >
                  <div class="col-lg-12">
                    <div
                      ...
                      v-show="index < hebergement.nbr_chambre_type_chambre"
                    >
                      <div class="row m-0 w-100" style="padding: 10px">
                        <div
                          class="col-md-1 d-none d-lg-block"
                          v-if="chambres.length > 1"
                        >
                          <label>&nbsp;</label>
                          <button
                            type="button"
                            v-if="chambres.length > 1"
                            v-on:click="removeChambre(index)"
                            class="
                        ...
                        <div class="form-group col-lg-2 col-md-6">
                          ...
                          <input
                            ...
                            class="form-control"
                            placeholder="nom"
                            :name="`chambres[${index}][nom]`"
                          />
                        </div>

                        <div class="form-group col-lg-3 col-md-6">
                          <label style="line-height: 35px">
                            <b> Lits du Chambre {{ index + 1 }}</b>
                          </label>
                          <input
                            aria-label="label"
                            v-model="chambre.nb_lit"
                            type="text"
                            class="form-control"
                            placeholder="nombres des lits"
                            :name="`chambres[${index}][nb_lit]`"
                          />
                        </div>
                        ...
                        <div class="form-group col-lg-3 col-md-6">
                          <label style="line-height: 35px">
                            <b>
                              Nombres des invités du Chambre {{ index + 1 }}</b
                            >
                          </label>
                          <input
                            aria-label="label"
                            v-model="chambre.nb_places"
                            type="text"
                            class="form-control"
                            placeholder="Nombres des invités"
                            :name="`chambres[${index}][nb_places]`"
                          />
                        </div>

                        <div class="form-group col-lg-3 col-md-6">
                          <label style="line-height: 35px">
                            <b> Prix du Chambre {{ index + 1 }}</b>
                          </label>
                          <input
                            aria-label="label"
                            v-model="chambre.prix"
                            type="text"
                            class="form-control"
                            placeholder="prix du chambre"
                            :name="`chambres[${index}][prix]`"
                          />
                        </div>
                        ...
                        <div
                          ...
                          v-for="(file, k) in chambres[index].imagesChambres"
                          :key="k"
                        >
                          <div class="col-xs-8">
                            <ul>
                              <div class="file_item">
                                ...
                                <img
                                  loading="lazy"
                                  @click="
                                    Remove_Image_Chambre(k, chambre, file)
                                  "
                                  class="close"
                              ...
                              <input
                                ...
                                :name="`chambres[${index}][imagesChambres][${k}][url_image]`"
                      ...
                      <div class="row">
                        <button
                          ...
                          class="btn btn-outline-success orange"
                        >
                          + Photo
                        </button>
                      </div>
                      ...
                      <!-- <div class="row">
                  <div class="col-md-12">
                    <p class="title">Photos de votre chambre</p>
                    <form>
                      <div class="form-group">
                        
                        <input
                          aria-label="label"
                          v-if="imagesC.length < 4"
                          type="file"
                          accept="image/*"
                          multiple="multiple"
                          @change="previewMultiImageC"
                          class="form-control-file"
                          id="my-file"
                        />

                        <div class="row">
                          <div class="col-md-3" v-for="(item, index) in preview_listC" :key="index">
                            <img loading="lazy" @click="RemoveC(item, index)" class="close" src="close-etnafes.png" />
                            <br />
                      ...
                      <!-- <div style="padding: 24px;margin-top: -49px;" class="row">
                  <div class="form-group col-md-12 pr-md-1 text-left">
                    <label>Image de couverture du chambre  {{ index + 1 }}</label>
                    <br />
                    <input
                      aria-label="label"
                      required
                ...
                <div class="row">
                  <div class="col-md-3 pr-md-1 text-left">
                    <base-input
                      ...
                      type="number"
                      class="numHeb"
                      placeholder="hambres disponibles"
                      disabled
                      :value="
                    ...
                    ></base-input>
                    <p
                      v-if="validationErrors.nbr_chambre_dispo"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >* {{ validationErrors.nbr_chambre_dispo[0] }}</span
                  ...
                  <div class="col-md-3 px-md-1 text-left">
                    ...
                    ></base-input>
                    <p
                      v-if="validationErrors.chambre_individuel"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.chambre_individuel[0] }}</span
                      >
                    </p>
                  </div>
                  ...
                  <div class="col-md-3 pl-md-1 text-left">
                    ...
                    ></base-input>
                    <p
                      v-if="validationErrors.chambre_a_deux"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.chambre_a_deux[0] }}</span
                      >
                    </p>
                  </div>
                  ...
                  <div class="col-md-3 pl-md-1 text-left">
                    ...
                    ></base-input>
                    <p
                      v-if="validationErrors.chambre_a_trois"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.chambre_a_trois[0] }}</span
                      >
                    </p>
                  </div>
                </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select
                            class="form-control"
                            required
                            v-model="hebergement.sous_ville_id"
                          >
                ...
                <div class="row">
                  <div class="col-md-12 pr-md-1 text-left">
                    ...
                    <div
                      class="image-preview11 style_image"
                      v-if="image_couverture.length > 0"
                    >
                      <img
                        loading="lazy"
                  ...
                  <div class="col-md-12 text-left">
                    <base-input>
                      ...
                      <span
                        ...
                        v-if="hebergement.description.length < 50"
                        >{{ hebergement.description.length }}/50</span
                      >
                      <span
                        style="float: right; color: green"
                        v-if="hebergement.description.length > 50"
                        >{{ hebergement.description.length }}/750</span
                      >
                      <textarea
                        rows="4"
                        cols="80"
                        maxlength="750"
                        class="form-control"
                        placeholder="Entrez ici la description de votre hébergement"
                        name="description"
                ...
                <div class="row">
                  <div class="col-md-12">
                    <h5 class="title">
                      Dates réservées :
                      <span v-for="(iii, index) in order" :key="index" hidden>{{
                        iii
                      }}</span>
                      <!-- moez -->
                      <br />
                ...
                <div class="row">
                  <div class="col-md-12 text-left">
                    <h5 class="title">Photos de votre hébergement</h5>
                    <form>
                      <div class="form-group">
                ...
                <div class="row" hidden>
                  <div class="col-md-12 text-left">
                    ...
                    <input
                      ...
                      v-model="hebergement.proprietaire_id"
                    />
                  </div>
                </div>
                <br />
      ...
      <b-tab title="Mes Hébergements">
        <template #title>
          Mes Hébergements
          <span
            class="badge badge-pill badge-danger"
            style="background-color: red"
            >{{ hebergementsunread }}</span
          >
        </template>
      ...
      <b-tab title="Mes réservations">
        <template #title>
          ...
          <span
            class="badge badge-pill badge-danger"
            style="background-color: red"
            >{{ reservationsUnread + reservationspUnread }}</span
          >
        </template>
        <br />
        <div style="margin-left: -5px">
          <ProprietaireReservations></ProprietaireReservations>
        </div>
      </b-tab>

      <b-tab title="Statistiques">
        <DashboardProprietaire></DashboardProprietaire>
      </b-tab>

      <b-tab title="Profil">
        <ProprietaireProfile></ProprietaireProfile>
      </b-tab>
    </b-tabs>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      dateAjouter: null,
      menu2: false,
      datesAll: [new Date().toISOString().slice(0, 10)],
      /* moez */
      list: [],
      auto: false,
      filesun: [],
  ...
  methods: {
    ...
    removeChambre: function (index) {
      Vue.delete(this.chambres, index);
      this.hebergement.nbr_chambre_type_chambre =
        Number(this.hebergement.nbr_chambre_type_chambre) - 1;
    },
    addImage: function (index) {
      this.chambres[index].imagesChambres.push({ name: "" });
      this.$nextTick(function () {
        var inputId =
          "file-" + (this.chambres[index].imagesChambres.length - 1);
    ...
    previewMultiImageC: function (event) {
      var input = event.target;
      var count = input.files.length;
      var index = 0;
      if (/\.(jpe?g|png|PNG|gif)$/i.test(input.files[index].name)) {
        while (count--) {
          var reader = new FileReader();
          reader.onload = (e) => {
            this.preview_listC.push(e.target.result);
          };
          this.imagesC.push(input.files[index]);
          reader.readAsDataURL(input.files[index]);
          index++;
        }
      } else {
        if (
          ...
          console.log("test" + this.imagesC.length);
          this.imagesC[this.imagesC.length].splice([this.imagesC.length], 1);
          this.preview_listC[this.preview_listC.length].splice(
            [this.preview_listC.length],
            1
          );
        }
      }
    ...
    Remove_Image_Chambre(index, chambre, file) {
      chambre.imagesChambres.splice(index, 1);

      // this.preview_list.splice(index, 1);
      /* this.chambres[k].imagesChambres.splice(k, 1);
      console.log("testDelete" + k); */
    },
    ...
    RemoveC(file, index) {
      this.preview_listC.splice(index, 1);
      this.imagesC.splice(index, 1);
      console.log("testDelete" + index);
    },
    updateVilleid(e) {
    ...
    createHebergement(e) {
      ...
      formData.append("type", this.hebergement.type);
      ...
      if (this.hebergement.nbr_chambre_dispo > 0) {
        for (var j = 0; j < this.chambres.length; j++) {
          formData.append("chambres[" + j + "][nom]", this.chambres[j].nom);
          formData.append(
            "chambres[" + j + "][nb_lit]",
            this.chambres[j].nb_lit
          );
          formData.append(
            "chambres[" + j + "][nb_places]",
            this.chambres[j].nb_places
          );
          formData.append("chambres[" + j + "][prix]", this.chambres[j].prix);

          for (var l = 0; l < this.chambres[j].imagesChambres.length; l++) {
            let name = this.chambres[j].imagesChambres[l].name;

            formData.append(
              "chambres[" + j + "][imagesChambres][" + l + "][url_image]",
              name
            );
          }
        }
