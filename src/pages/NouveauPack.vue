      ...
      <div class="col-md-12">
        <card>
          <template slot="header">
            <h5 class="title" style="padding-top: 15px">Ajouter un pack</h5>
          </template>
            ...
            <card style="border: solid 1px #7a7979; padding: 15px">
              <!-- <div class="row">
                ...
                <div class="col-md-4 px-md-1 text-left">
                  ...
                  <VueDatePicker :minDate="new Date()" v-model="pack.date_deb" required />
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3 pl-md-1 text-left">
                  ...
                  >
                    <span class="alert-link"
                      >** {{ validationErrors.activite_id_principal[0] }}</span
                    >
                  </p>
                </div>
              </div>
              ...
              <br />
              <!-- <div class="row">
                <button class="btn btn-success" fill style="margin-left:10px">Suivant</button>
              </div>-->
            </card>
            <br />
            <div>
              <card style="border: solid 1px #7a7979; padding: 15px">
                <div class="row">
                  <div class="col-md-12">
                    <h4>
                      <b>Veuillez ajouter le programme de votre pack</b>
                    </h4>
                  </div>
                </div>
                <!-- <br /> -->
              ...
              <card style="border: solid 1px #7a7979; padding: 15px">
                <div class="row">
                  <div class="col-md-12">
                    <h4>
                      <b>Veuillez choisir les zones touristiques</b>
                    </h4>
                  </div>
                </div>
                <!-- <br /> -->
    ...
    packPhoto: function (event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          vm.pack.image_couverture = e.target.result;
        };
