<template>
  <div class="content">
    <b-tabs class="py-2" card>
              ...
              <card style="border: solid 1px #7a7979">
                <div class="row m-0 w-100">
                  ...
                  <div class="col-md-3 px-md-1 text-left">
                    ...
                    <VueDatePicker
                      v-if="seendeb == true"
                      :max-date="new Date(pack.date_fin)"
                      :minDate="new Date()"
                      v-model="pack.date_deb"
                      required="true"
                    />
                  ...
                  <!-- <div class="col-md-2 pl-md-1 text-left">
                    ...
                    <VueDatePicker
                      @input="calculInterval,seendeb=true,
                       difference =Math.floor(( Date.parse(pack.date_fin) - Date.parse(pack.date_deb) ) / 86400000)"
                      v-else
                      :minDate="new Date(pack.date_deb)"
                      v-model="pack.date_fin"
                      :input-attr="{ required: 'true' }"
                ...
                <div class="row m-0 w-100">
                  <div class="col-md-3 pr-md-1 text-left">
                    ...
                    <p
                      v-if="validationErrors.adrenaline"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.adrenaline[0] }}</span
                      >
                    </p>
                  </div>
                  ...
                  <div class="col-md-3 pl-md-1 text-left">
                    <label>Agence/Entreprise {{pack.agence_id}}</label>
                    <select
                      class="form-control"
                      v-model="pack.agence_id"
                      name="agence_id"
                      required
                    >
                      <option
                      ...
                      >
                        {{ agence.nom_agence }}
                        <span v-if="agence.valide == 0">(en attente)</span>
                      </option>
                    </select>
                ...
                <div class="row m-0 w-100">
                  <div class="col-md-3 pr-md-1 text-left">
                    ...
                    />
                    <p
                      v-if="validationErrors.nb_place_max"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.nb_place_max[0] }}</span
                      >
                    </p>
                  </div>
                  <div class="col-md-3 px-md-1 text-left">
                    ...
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.nb_place_dispo[0] }}</span
                      >
                    </p>
                  </div>
                  <div class="col-md-3 pl-md-1 text-left">
                    ...
                    />
                    <p
                      v-if="validationErrors.prix_fix"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.prix_fix[0] }}</span
                      >
                    </p>
                  </div>
                  <div class="col-md-3 pl-md-1 text-left">
                    ...
                    />
                    <p
                      v-if="validationErrors.prix_enfant4"
                      style="padding-bottom: 5px; color: red"
                    >
                      <span class="alert-link"
                        >** {{ validationErrors.prix_enfant4[0] }}</span
                      >
                    </p>
                  </div>
                </div>
                          ...
                          >
                            <div class="row" style="padding-left: 20px">
                              ...
                              >
                                <div
                                  v-show="
                                    hebergement.ville_id == zone.ville_id &&
      ...
      <b-tab title="Réservations Pack" v-if="adagence.adagence == 1">
        <template #title>
          Réservations Pack
          <span
            v-if="Number(reservationsP) + Number(reservationsH) > 0"
            class="badge badge-pill badge-danger"
            style="background-color: red"
          >
            <span>{{ Number(reservationsP) + Number(reservationsH) }}</span>
          </span>
        </template>
        <ReservationsAgence></ReservationsAgence>
      </b-tab>

      <b-tab title="Réservations Pack" disabled v-if="adagence.adagence == 0">
        <template #title>
          Réservations Pack
          <span
            v-if="Number(reservationsP) + Number(reservationsH) > 0"
