      ...
      <b-card no-body class="mt-4">
        <b-tabs card style="margin-top: -38px !important">
          <b-tab title="Réservations pack" active>
            ...
            <div
              v-if="
                reservationspack.data.length == 0 &&
                filteredReservationsPack.length == 0
              "
            >
              <p style="padding-top: 15px">
                Vous n'avez aucune réservation jusqu'au moment.
              </p>
            </div>
            ...
            >
              <p style="padding-top: 15px">
                Votre recherche ne correspond à aucune réservation.
              </p>
            </div>
          ...
          <b-tab title="Réservations aux hébergements">
            ...
            <div
              v-if="
                reservationsLibre.data.length == 0 &&
                filteredReservationsLibre.length == 0
              "
            >
              <p style="padding-top: 15px">
                Vous n'avez aucune réservation jusqu'au moment.
      ...
      <div class="container">
        <div class="col-md-12">
          <i
            ...
            title="Delete reservation"
          ></i>
          <span style="color: #707e94; font-size: 13px"
            >La suppression d'une réservation sera impossible si le voyageur a
            déja payé.</span
          >
          <br />
          <br />
          ...
          ></i>
          <span style="color: #707e94; font-size: 13px"
            >Le voyageur a payé sa réservation.</span
          >
          <br />
          <br />
          <i class="fa fa-times-circle mr-3 text-danger fa-lg"></i>
          <span style="color: #707e94; font-size: 13px"
            >Le voyageur n'a pas encore payé sa réservation.</span
          >
        </div>
      </div>
    </div>
