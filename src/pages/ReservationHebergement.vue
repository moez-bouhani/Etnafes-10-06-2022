<template>
  <div>
    ...
    >
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="card-body" style="border: solid 1px #afaeae">
            ...
            <form name>
              ...
              <h4
                class="dark-grey-text"
                style="line-height: 25px; font-family: 'Open Sans', sans-serif"
              >
                <!--  <strong
                  style="
                    color: #333;
        ...
        <div class="col-md-6">
          <div class="card-body" style="border: solid 1px #afaeae">
            ...
            <span style="font-weight: bold; color: #000">Dates</span>
            <br />
            {{ du }} / {{ au }} ({{ calculIntervalDateRes_calender.length }}
            nuits)
            <br />
            <br />
            <!-- <br />
      ...
      >
        <b-button v-if="type_paiement == 'offline' && verif_dipo >= 0"
          >Demande de réservation offline</b-button
        >
      </router-link>
    </div>
    ...
    >
      <div class="row">
        <div class="col-md-6">
          <div class="card-body" style="border: solid 1px #afaeae">
            <form name>
              <h4
                class="dark-grey-text d-none d-lg-block"
              ...
              <h4
                class="dark-grey-text d-lg-none"
                      ...
                      :to="{
                        ...
                        query: {
                          du:
                            ...
                            this.dateHebergement.startDate
                              ? this.$route.query.du
                              : this.convert_date_du_chambre,
                          au:
                            this.$route.query.au == this.dateHebergement.endDate
                              ? this.$route.query.au
                              : this.convert_date_au_chambre,
              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <p style="color: rgb(51, 51, 51); margin-top: -25px">
                    ...
                    <span>&nbsp;{{ chambre.nb_places }} personnes</span>
                  </p>
                </div>
                <div
                  class="col-md-7"
        ...
        <div class="col-md-6">
          <div class="card-body" style="border: solid 1px #afaeae">
            ...
            >
              <strong style="font-family: 'Indie Flower', cursive; color: #000"
                >Demande de réservation offline :</strong
              >
              &nbsp;
              <strong
                style="font-family: 'Indie Flower', cursive; color: #ff931f"
      ...
      <!-- reservation par chambre -->
      <button
        @click="stepOnePayemeec()"
        v-b-modal.modal-paymee
        v-if="type_paiementc == 'en ligne' && verif_dipo_chambre >= 0"
        class="btn btn-success d-none d-lg-block"
        type="submit"
        fill
        style="margin-left: 10px"
      ...
      <router-link
        ...
        :to="{
          ...
          query: {
            ...
            nbr_places_reserves: this.nbr_places_total_Moez_chambre,
            places_disponibles: this.nbr_places_dispo_Moez_chambre,
          },
        }"
      >
        <b-button v-if="type_paiementc == 'offline' && verif_dipo_chambre >= 0"
          >Demande de réservation offline</b-button
        >
      </router-link>
    </div>
    ...
    >
      ...
      >
        ...
        >
          <b-button
            class="btn-info btn-block"
            v-if="type_paiementc == 'offline' && verif_dipo_chambre >= 0"
            >Demande de réservation</b-button
          >
        </router-link>
      </div>
    </div>
    <!-- fin reservation par chambre web et mobile -->
    <div
      v-if="
        hebergement.type == 'par personne' ||
        hebergement.type == 'Logement entier'
    ...
    >
      ...
      >
        ...
        >
          <b-button
            class="btn-info btn-block"
            v-if="type_paiement == 'offline' && verif_dipo >= 0"
            >Demande de réservation offline</b-button
          >
        </router-link>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      nb_adultec: this.$route.query.nb_adulte,
  ...
  created() {
    ...
    this.fetchChambre(this.$route.query.chambreid);
  ...
  computed: {
    calcul_pourcentage() {
      return (
        (this.hebergement.pourcentage[0].pourcentage * this.sommeMoezChambre) /
        100
      );
    },
    ...
    fetch_res_najeh_moez_chambre(id) {
      fetch(
        ...
        .then((res) => res.json())
        .then((res) => {
          this.res_najeh_moez_chambre = res;
        });
    },
...
return result; */
    ...
    convert_date_du_chambre() {
      if (this.dateHebergementChambre.startDate != "") {
    ...
    nbr_places_total_Moez_chambre() {
      return Number(this.chambre.nb_places);
    },
    ...
    nbr_places_dispo_Moez_chambre() {
      return (
        Number(this.hebergement.nbr_place_dispo) -
        Number(this.nbr_places_total_Moez_chambre)
      );
    },
    ...
    sommeMoezChambre() {
      return (
        this.calculIntervalDateResChambre_calender.length * this.chambre.prix
      );
    },
    loggedIn() {
  ...
  methods: {
    ...
    stepOnePayemee() {
      ...
      axios
        ...
        .then((res) => {
          ...
          localStorage.setItem("frais", this.calcul_pourcentage);
          localStorage.setItem("type", this.hebergement.type);
    ...
    stepOnePayemeec() {
      let formData = new FormData();
      formData.append("vendor", this.code_compt);
      formData.append("amount", this.sommeMoezChambre);
      formData.append("note", this.note);
      axios
        .post(`https://app.paymee.tn/api/v1/payments/create`, formData, {
          body: JSON.stringify(this.annonce),
        ...
        .then((res) => {
          ...
          //query
          localStorage.setItem("logement_id", this.$route.params.id);
          localStorage.setItem("prix_logement", this.sommeMoezChambre);
          localStorage.setItem("du", this.du);
          localStorage.setItem("au", this.au);
          localStorage.setItem("nom_hebergement", this.hebergement.nom);
          localStorage.setItem("type", this.hebergement.type);
          localStorage.setItem("arr", this.calculIntervalDateRes_calender);
          localStorage.setItem("nb_enfant4", 0);
          localStorage.setItem("nb_enfant15", 0);
          localStorage.setItem("nb_enfants", 0);
          localStorage.setItem("frais", this.calcul_pourcentage);

          localStorage.setItem("nb_adultes", this.chambre.nb_places);
          localStorage.setItem(
            "nbr_places_dispo_Moez",
            this.nbr_places_dispo_Moez
          );
          localStorage.setItem(
            "nbr_places_total_Moez",
            this.$route.query.nb_places_chambre
          );

          localStorage.setItem("chambre_id ", this.$route.query.chambreid);
        })
        .catch((error) => {
          console.log(error.response.data);
        });
