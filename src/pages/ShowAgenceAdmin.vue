            ...
            <div class="row g-0">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <hr />
                  <p>
                    <label style="color: green" v-if="adagence.adagence != 0"
                      >Proprietaire de l'agence Validée
                      <i
                        v-if="adagence.adagence != 0"
                        onmouseover="this.style.cursor='pointer'"
                        title=" le proprietaire de l'agence Validée"
                  ...
                  <p>
                    <label style="color: red" v-if="adagence.adagence == 0"
                      >Proprietaire de l'agence Non Validée
                      <i
                        v-if="adagence.adagence == 0"
                        onmouseover="this.style.cursor='pointer'"
                  ...
                  <p>
                    <label style="color: green" v-if="agence.valide != 0"
                      >Agence Validée
                      <i
                        title=" l'agence Validée"
                  ...
                  <p>
                    <label style="color: red" v-if="agence.valide == 0"
                      >Agence Non Validée
                      <i
