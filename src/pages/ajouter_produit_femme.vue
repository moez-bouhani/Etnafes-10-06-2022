      ...
      <div class="col-md-12">
        <card>
          <template slot="header">
            <h5 class="title" style="padding-top: 15px">Ajouter un produit</h5>
          </template>
          <form @submit.prevent="createProduit">
            <div class="row">
              <div class="col-md-4 pr-md-1 text-left">
                ...
                <input
                  type="text"
                  style="height: calc(2.75rem + -5px) !important"
                  label="Nom"
                  placeholder="Nom"
                  v-model="zone.titre"
                />
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12">
                <h5 class="title">Photos des produits</h5>
                <form>
                  <div class="form-group">
            ...
            <div class="row">
              ...
              >
                {{ loading ? "En cours d'enregistrement ..." : "Ajouter" }}
              </button>
            </div>
          </form>
        </card>
...
export default {
  ...
  data() {
    return {
      ...
      zone: {
        ...
        zone_id: this.$store.state.femme[0].zone_id,
  ...
  methods: {
    ...
    previewMultiImage: function (event) {
      ...
      var index = 0;
      if (/\.(jpe?g|png|PNG|gif|webp)$/i.test(input.files[index].name)) {
        while (count--) {
    ...
    createProduit(e) {
      ...
      formData.append("zone_id", this.zone.zone_id);
      ...
      axios
        ...
        .then((res) => {
          ...
          if (res.status == 200) {
            ...
            this.$router.push("/listes_mes_produit");
          }
        })
        .catch((error) => {
          this.loading = false;
